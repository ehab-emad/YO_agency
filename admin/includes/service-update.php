<?php
$id = $_GET['id'];
$data = $connect->query("SELECT * FROM `services` WHERE id='$id'");
$data = $data->fetch_assoc();
?>
<div class="page-title">
    <i class="fa-solid fa-puzzle-piece"></i> <span>لوحة التحكم /</span> <strong>تحديث خدمة </strong>
</div>
<form action="functions/update_service.php" method="post" enctype="multipart/form-data">
    <?php
    ...
    <input type="text" name="serv_name" placeholder="ادخل اسم الخدمة" value="<?php echo $data['serv_name'] ?>" required>
    <label for="" style="padding: 0px;border:none !important">وصف الخدمة</label>
    <textarea type="text" name="serv_description" placeholder="ادخل وصف الخدمة"><?php echo $data['serv_description'] ?></textarea>
    <div class="file-box">
        <div class="layer">
            <div class="child">
                <p>upload image</p>
